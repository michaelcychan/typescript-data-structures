...
describe("Tree", () => {
  describe("number as data", () => {
    ...
    describe("add a child", () => {
      it("add a Tree child", () => {
        ...
        expect(tree50.getChildren()[0].getValue()).toBe(30);
      });
  ...
  describe("string as data", () => {
    it("initialises with data", () => {
      const tree50 = new Tree("root");
  
      expect(tree50.getValue()).toBe("root");
    });
    describe("add a child", () => {
      it("add a Tree child", () => {
        const tree50 = new Tree("root");
        const tree30 = new Tree("leave");
        
        tree50.addChild(tree30);
        
        expect(tree50.getChildren()).toContain(tree30);
        expect(tree50.getChildren()[0].getValue()).toBe("leave");
      });
      it("add a string child", () => {
        const tree50 = new Tree("root");
        const tree30 = new Tree("leave");
        
        tree50.addChild("leave");
    ...
    describe("removeChild", () => {
      it("removes a child by node (same value but two distinct nodes)", () => {
        ...
        const tree30ToBeRemoved = new Tree("leave");
    ...
    describe("stringify", () => {
      it("stringify tree with only root", () => {
        const tree50 = new Tree("root");
        expect(tree50.stringify()).toBe("root\n");
      })
  
      it("stringify the tree", () => {
        const tree50 = new Tree("root");
        const tree30 = new Tree("branch1");
        const tree10 = new Tree("deeper branch");
        const tree1 = new Tree("leave");
        const tree2 = new Tree("anotherleave");
  
        const tree20 = new Tree("suddenbranch");
